...
-- Utilizar la Bd desde el WorkBench
USE sakila;
...
-- 2a.  You need to find the ID number, first name, and last name of an actor, of whom you know only the first name, "Joe." What is one query would you use to obtain this information? A query in the actor table with this columns: actor_id, first_name, last_name and we need to filter by the name Joe
